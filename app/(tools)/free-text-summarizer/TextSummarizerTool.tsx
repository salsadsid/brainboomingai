                ...
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-600 dark:text-slate-400 font-medium">
                      Summary Generated · {wordCount(output)} words ·{" "}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Our AI intelligently identifies key points and main ideas to
              create concise, comprehensive summaries while preserving essential
              information.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Maintains the original context and meaning while condensing
              lengthy articles, reports, and documents into digestible
              summaries.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Get professional-quality summaries in seconds. Perfect for
              research, studying, content creation, and quick information
              processing.
            </p>
          </motion.div>
        </div>
      ...
      <div className="mt-16 mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Paste your long article, document, or content into the text area.
              Our tool can handle various types of text content up to 5000
              characters.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Our advanced AI analyzes the content structure, identifies key
              points, and understands the main themes to create an accurate
              summary.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Receive a well-structured summary that captures the essence of
              your content while significantly reducing length and complexity.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  You can summarize articles, research papers, blog posts,
                  reports, essays, news articles, and any other text content.
                  Our AI works best with well-structured, informative text.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  For best results, input text should be at least 200 words
                  long. Our tool can handle up to 5000 characters, making it
                  perfect for most articles and documents.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Our AI automatically determines the optimal summary length
                  based on the input content. It aims to reduce the original
                  text by 70-80% while preserving all key information.
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  temporarily for summarization and is not stored on our servers
                  or shared with third parties. All processing happens securely.
                </p>
              </div>
            </div>
          </motion.div>
