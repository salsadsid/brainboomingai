...
export default function Home() {
  return (
    <div className="min-h-screen max-w-7xl mx-auto bg-gradient-to-b from-background to-muted/10 dark:from-slate-900 dark:to-slate-950/30">
      <section className="container relative py-20 text-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="max-w-4xl mx-auto"
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent dark:to-purple-400">
            Transform Your Workflow with AI
          </h1>
          <p className="text-xl text-muted-foreground mb-8 dark:text-slate-400">
          ...
          <div className="flex gap-4 justify-center">
            <Link href="/free-ai-to-human">
              <Button
                size="lg"
                variant="outline"
                className="gap-2 text-base bg-gradient-to-tr from-slate-200 to-purple-600 text-white hover:bg-gradient-to-bl hover:shadow-lg hover:text-white dark:from-slate-800 dark:to-indigo-600 dark:hover:to-indigo-500"
        ...
        {/* <div className="absolute inset-0 bg-[url('/premium_photo.jpeg')] opacity-50 mix-blend-soft-light" /> */}
      </section>
